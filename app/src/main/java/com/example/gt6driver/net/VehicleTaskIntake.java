...
public class VehicleTaskIntake {
    ...
    public static class Description {
        ...
        @SerializedName("isIncorrectMileage")
        public Boolean isIncorrectMileage;

        @SerializedName("isInCorrectVin")
        public Boolean isInCorrectVin;

        @SerializedName("isIncorrectSpelling")
        public Boolean isIncorrectSpelling;

        @SerializedName("isIncorrectDetails")
        public Boolean isIncorrectDetails;
    }
    ...
    public static class Quality {
        @SerializedName("isConcerns")
        public Boolean isConcerns;

        @SerializedName("isExteriorDamage")
        public Boolean isExteriorDamage;

        @SerializedName("isTiresWheels")
        public Boolean isTiresWheels;

        @SerializedName("isServiceLights")
        public Boolean isServiceLights;

        @SerializedName("isInteriorDamage")
        public Boolean isInteriorDamage;

        @SerializedName("isMechanical")
